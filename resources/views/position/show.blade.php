                ...
                <table>
                    ...
                    <?php 
                            foreach($votes as $vote){
                                ...
                                if($vote->vote->voter->person->barangay->city->province->region_id==$region->id){
                    ...
                    ?>
                            <td>{{$count}}</td>
                            <td><a href="{{ route('region.show',['id'=>$electoral->id]) }}" class="btn btn-info">View Details</a></td>
                            </tr>
                    <?php
                        }
                    ?>
...
<div class="container">
    <a href="{{ route ('province.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>Print Report</a>
