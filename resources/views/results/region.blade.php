...
<center><h1><b>{{ $electoral->position->description }}</b></h1></center> <br><br>
            ...
            <div class="table-responsive">
                <table id="table">
                    ...
                    ?>
                            <td>{{$count}}</td>
                            <td><a href="{{ route('resultsPerProvince',['id'=>$electoral->id,'region_id'=>$region->id]) }}" class="btn btn-info">View Details</a></td>
                            </tr>
                    <?php
                        }
                    ?>
...
<div class="container">
                ...
                <a href="{{ route ('results') }}" class="btn btn-danger"></i>Back</a>
