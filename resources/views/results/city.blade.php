                ...
                <table id="table">
                    ...
                    <?php 
                            foreach($votes as $vote){
                                ...
                                if($vote->vote->voter->person->barangay->city_id==$city->id){
                    ...
                    ?>
                            <td>{{$count}}</td>
                            <td><a href="{{ route('resultsPerBarangay',['id'=>$electoral->id,'city_id'=>$city->id]) }}" class="btn btn-info">View Details</a></td>
                            </tr>
                    <?php
                        }
                    ?>
